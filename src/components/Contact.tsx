...
const Contact = () => {
  const bgImg = `${BASE_URL}hero_image4.png`;
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute -inset-y-[100%] -left-[50%] w-[200%] h-[300%] bg-gradient-to-tr from-transparent via-white/40 to-transparent transform -rotate-12 pointer-events-none blur-sm z-0" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gold-300/10 rounded-full blur-3xl pointer-events-none animate-pulse z-0" />
